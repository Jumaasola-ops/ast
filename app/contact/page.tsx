      ...
      <nav className="fixed top-0 w-full z-50 bg-white/95 backdrop-blur-sm border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 sm:py-5 flex justify-between items-center">
          ...
          <div className="hidden md:flex gap-8 lg:gap-12 items-center absolute left-1/2 transform -translate-x-1/2">
            ...
            <Link href="/contact" className="text-gray-500 hover:text-gray-900 transition text-xs sm:text-sm font-semibold text-teal-600">Contact Us</Link>
          </div>
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden bg-white border-t border-gray-100">
            <div className="px-4 py-4 space-y-3">
              ...
              <Link href="/contact" onClick={() => setIsMobileMenuOpen(false)} className="block px-3 py-2 text-teal-600 hover:text-gray-900 hover:bg-gray-50 rounded-lg transition text-sm font-semibold">Contact Us</Link>
            </div>
          </div>
        )}
      </nav>
